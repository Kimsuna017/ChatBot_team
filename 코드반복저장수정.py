...
TEST, REALTARO, MENU, TARO_B, TARO_D, DOOR, ANIMAL, PICTURE, NUMBER, GREEN, BLUE, RED, PURPLE, GREY, A, B, C, D, CANCEL = range(
    19)
...
if __name__ == '__main__':
    ...
    #     states={
    #         REALTARO: [CallbackQueryHandler(realtaro)],
    #         MENU: [CallbackQueryHandler(realtaro)]
    #     },
    #     fallbacks=[CommandHandler('TEST', test)]
    # )
    #
    # conv_handler3 = ConversationHandler(
    #     entry_points=[CommandHandler('REALTARO', start)],
    #     states={
    #         TARO_B: [CallbackQueryHandler(taro_b)],
    #         TARO_D: [CallbackQueryHandler(taro_d)]
    #     },
