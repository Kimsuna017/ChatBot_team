...
def test(bot, update):
    ...
    show_list.append(InlineKeyboardButton("추천", callback_data="추천"))
...
def callback_get(bot, update):
    ...
    if update.callback_query.data == "추천":
...
def recommand(bot, update):
    ...
    bot.sendMessage(chat_id=update.message.chat_id, text='무슨 메뉴를 골라야 할지 고민이라구요?')
    time.sleep(0.5)
    bot.sendMessage(chat_id=update.message.chat_id, text='걱정하지 마세요! 제가 추천해 드릴게요!!')
    time.sleep(0.5)
    bot.sendMessage(chat_id=update.message.chat_id, text='저희 타로심리봇 이용 횟수는 총')
    #bot.sendMessage(chat_id=update.message.chat_id, text=Sum)
    bot.sendMessage(chat_id=update.message.chat_id, text='명인데요!')
    time.sleep(0.5)
    ...
    if (birth > tod and birth > door and birth > animal and birth > photo and birth > number):
        Max = birth
        bot.sendMessage(chat_id=update.message.chat_id, text='타로테마의 생일점 이용자 수가')
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text=Max)
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text='명으로 가장 인기가 많네요!')
        time.sleep(0.5)
    ...
    if (tod > birth and tod > door and tod > animal and tod > photo and tod > number):
        Max = tod
        bot.sendMessage(chat_id=update.message.chat_id, text='타로테마의 오늘의 운세 이용자 수가')
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text=Max)
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text='명으로 가장 인기가 많네요!')
    ...
    if (door > birth and door > tod and door > animal and door > photo and door > number):
        Max = door
        bot.sendMessage(chat_id=update.message.chat_id, text='심리테마의 문 메뉴 이용자 수가')
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text=Max)
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text='명으로 가장 인기가 많네요!')
    ...
    if (animal > birth and animal > tod and animal > door and animal > photo and animal > number):
        Max = animal
        bot.sendMessage(chat_id=update.message.chat_id, text='심리테마의 동물 메뉴 이용자 수가')
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text=Max)
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text='명으로 가장 인기가 많네요!')
    ...
    if (photo > birth and photo > tod and photo > door and photo > animal and photo > number):
        Max = photo
        bot.sendMessage(chat_id=update.message.chat_id, text='심리테마의 사진 메뉴 이용자 수가')
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text=Max)
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text='명으로 가장 인기가 많네요!')
    ...
    if (number > birth and number > tod and number > door and number > animal and number > photo):
        Max = number
        bot.sendMessage(chat_id=update.message.chat_id, text='심리테마의 숫자 메뉴 이용자 수가')
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text=Max)
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text='명으로 가장 인기가 많네요!')
    ...
    if (birth < tod and birth < door and birth < animal and birth < photo and birth < number):
        Min = birth
        bot.sendMessage(chat_id=update.message.chat_id, text='그런데 타로테마의 생일점 메뉴 이용자 수가')
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text=Min)
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text='명으로 가장 인기가 없어 고민이에요ㅠㅠ')
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text='재밌으니까 한번만 해주세요!!♡')
    if (tod < birth and tod < door and tod < animal and tod < photo and tod < number):
        Min = tod
        bot.sendMessage(chat_id=update.message.chat_id, text='그런데 타로테마의 오늘의 운세 메뉴 이용자 수가')
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text=Min)
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text='명으로 가장 인기가 없어 고민이에요ㅠㅠ')
    ...
    if (door < birth and door < tod and door < animal and door < photo and door < number):
        Min = door
        bot.sendMessage(chat_id=update.message.chat_id, text='그런데 심리테마의 문 메뉴 이용자 수가')
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text=Min)
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text='명으로 가장 인기가 없어 고민이에요ㅠㅠ')
    ...
    if (animal < birth and animal < tod and animal < door and animal < photo and animal < number):
        Min = animal
        bot.sendMessage(chat_id=update.message.chat_id, text='그런데 심리테마의 동물 메뉴 이용자 수가')
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text=Min)
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text='명으로 가장 인기가 없어 고민이에요ㅠㅠ')
    ...
    if (photo < birth and photo < tod and photo < door and photo < animal and photo < number):
        Min = photo
        bot.sendMessage(chat_id=update.message.chat_id, text='그런데 심리테마의 사진 메뉴 이용자 수가')
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text=Min)
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text='명으로 가장 인기가 없어 고민이에요ㅠㅠ')
    ...
    if (number < birth and number < tod and number < door and number < animal and number < photo):
        Min = number
        bot.sendMessage(chat_id=update.message.chat_id, text='그런데 심리테마의 숫자 메뉴 이용자 수가')
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text=Min)
        time.sleep(0.5)
        bot.sendMessage(chat_id=update.message.chat_id, text='명으로 가장 인기가 없어 고민이에요ㅠㅠ')
    ...
    time.sleep(1.0)
    bot.sendMessage(chat_id=update.message.chat_id, text='어떤 메뉴를 고를지 결정하셨다면! /test 를 눌러보세요~')
