...
def sum(bot, update):
    ...
    if dd == 0 or dd == 22:
        bot.send_photo(chat_id = chat_id,
                       photo = 'http://thumb1.photo.cloud.naver.com/3472427554648900385?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9xznrQu88T7i+4rW7SUoCWhrTO2CrHCON1HbumbfbmzKj15Ish3oECjAndZw4lh7MLQU=&authtoken=GeFm/2+/NYa12fsLzSD2GgI=')
        ...
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='https://drive.google.com/open?id=1euK5xUcdbXSwAKDgFWgWMw_5a-vEnlYW')
        bot.sendMessage(chat_id=update.message.chat_id,
                        text="당신의 성격 카드는 '마법사' 입니다! 이 카드는 재주있는 사람을 말하며, 독창적이고 창조적이며 상상력이 뛰어남을 상징합니다. 능수능란한 재주가 있어 꾀를 부려도 남이 잘 알아채지 못합니다!")
    elif dd == 2 :
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb1.photo.cloud.naver.com/3472427554648068640?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9x1kyUvVUk1/5PADuOWqm3IPKf4Hib+AH+h1o8q0T8ugnax4Gxlp43Iw34tqTSQcAbwU=&authtoken=2LgK/sjp3B4EpKwdZemx+AI=')
        bot.sendMessage(chat_id=update.message.chat_id,
        ...
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb1.photo.cloud.naver.com/3472427554648048161?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9xw0MQxY7FRdkeMIj+dj+WhOVGbbU3LJGa/Mfq7u1y5p0SXUAgUkmolgif+YD3Mok7AU=&authtoken=ct6a1q5CbBwWp/LOENZnqwI=')
        bot.sendMessage(chat_id=update.message.chat_id,
                        text = "당신의 성격 카드는 '여제' 입니다! 이 카드는 부드러운 에너지가 발달한 사람을 말하며, 성취지향적이고 실용적입니다. 다른 사람을 돌보고 그들이 잘 성장할 수 있도록 돕고자 합니다!")
    elif dd == 4 :
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb1.photo.cloud.naver.com/3472427554648066593?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9x1kyUvVUk1/5PADuOWqm3IO2TmlykSyYET0FciV5oESxIIc6uddfsRB0n+7A5rRhHgU=&authtoken=B4HPGcNX0SZikyawAzSQVgI=')
        bot.sendMessage(chat_id=update.message.chat_id,
                        text = "당신의 성격 카드는 '황제' 입니다! 이 카드는 가장을 상징하며 가진 것을 지키려고 앴는 사람을 말합니다. 세속적인 힘과 안정, 권위, 확신, 이성을 상징합니다. 남성일 경우 가부장적인 인물을 뜻합니다!")
    elif dd == 5 :
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb2.photo.cloud.naver.com/3472427554648068129?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9x1kyUvVUk1/5PADuOWqm3IPEQw4YF2WtrTKcJ+N/PpLkMs1vJw1CdUy+28+HFRADDgU=&authtoken=ApPoDL75MUw9VHWrrMmV2QI=')
        bot.sendMessage(chat_id=update.message.chat_id,
        ...
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb1.photo.cloud.naver.com/3472427554648105504?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9x9ShSmaRXb7sBW8WNRMaArMFoSagtMeIBuBBSQeqMLHwmHqF+WKd2fRzeomdiYBbIgU=&authtoken=pgFOvBJ0TnUKFu7lBktwRQI=')
        bot.sendMessage(chat_id=update.message.chat_id,
        ...
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb2.photo.cloud.naver.com/3472427554648196384?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9xwCFy3+bnViFK87QgpUWtNWSkggfCMn//0duim9pPKVQcdM8GMuOezdfatKqwz7kkAU=&authtoken=7fDAZG49djwOmsdFaw+hswI=')
        bot.sendMessage(chat_id=update.message.chat_id,
        ...
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb1.photo.cloud.naver.com/3472427554648369441?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9xwuxECnrWUOLyyH8pcx4deGIEgKFduLlU1JG1ySnZKNN0kp7H2KZu7kO/sSi4cRzzQU=&authtoken=rG0YmxPBjSvk+AylAOnHcwI=')
        bot.sendMessage(chat_id=update.message.chat_id,
        ...
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb2.photo.cloud.naver.com/3472427554648429344?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9xzf+M2SA1Ztl99EtXwHfvcFPBl7O03e90XCZr5Vm/ujFrkXxsrfXtW3rx9m35dxJRQU=&authtoken=J45kgFSaR0CLjsZGj0pdLAI=')
        bot.sendMessage(chat_id=update.message.chat_id,
        ...
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb1.photo.cloud.naver.com/3472427554648660256?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9xyScqqH/p2HWG9MWTceCsJ0KX/vS5TQvlzJepTYlNvvcrndBt8Llh3Qsg25amBmy/QU=&authtoken=x32GFXL2npBYSfbYzpesQAI=')
        bot.sendMessage(chat_id=update.message.chat_id,
        ...
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb1.photo.cloud.naver.com/3472427554648525600?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9xxFGESAG+nBJTJrxNAjnAr/LTJErbFLc+1Y/1pyijcSunU8V+H5AM68RyVdUdiX0kgU=&authtoken=7N83hTAYYT6M4uZXpVGNmQI=')
        bot.sendMessage(chat_id=update.message.chat_id,
        ...
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb1.photo.cloud.naver.com/3472427554648549665?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9x/CwFMG5TRfXQUr1Pi1jrtOb2rQ9k+OyEJYsOsUBzZcRWMYtjW1safoCUtylRQaDIQU=&authtoken=4odUM6cWG4V4x/DgegjBHAI=')
        bot.sendMessage(chat_id=update.message.chat_id,
                        text = "당신의 성격 카드는 '악마' 입니다! 이 카드는 집착이 강한 사람을 말하며, 자신과 관련된 대상에 대해 걱정을 많이 합니다. 실패 경험을 너무 오래 생각하면 자신과 주변이 힘들어 질 수 있습니다.")
    elif dd == 16 :
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb2.photo.cloud.naver.com/3472427554648559648?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9x7pnovZiTrHNOqXu1Kj3FjER2KgDdaqrnGQ7El4HBNfmQV5dlSAboZMLBfpaubJ/GwU=&authtoken=4E9iBuBLIhP7y6iW3LTXSQI=')
        bot.sendMessage(chat_id=update.message.chat_id,
        ...
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb2.photo.cloud.naver.com/3472427554648692256?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9x6ppsN1vzwMg1NU/UROoh6jnPcZn64sccWCkVfSJkJMudgea5K02i4AXUniKqPVWDQU=&authtoken=mb7EGeW47cFSozXy+6WocAI=')
        bot.sendMessage(chat_id=update.message.chat_id,
        ...
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb2.photo.cloud.naver.com/3472427554648705568?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9x2UoC4cjV5+jbvRWun8/hSuGiXK+yf6X7Tg9DmCLGGg02EZtWRAXJb0vMDKGWkmqfwU=&authtoken=WTQDrxLFq8g3jXhPkO7yGQI=')
        bot.sendMessage(chat_id=update.message.chat_id,
        ...
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb1.photo.cloud.naver.com/3472427554648756768?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9x7RS0p5Vi/SPI7N/Pxfn8xtWZZMxLUpUQY5wtL7C/9VmEcWbI0dl8IAuiSpoLk5mVgU=&authtoken=HYiwG6qdCkSgGKs17MnLRgI=')
        bot.sendMessage(chat_id=update.message.chat_id,
        ...
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb1.photo.cloud.naver.com/3472427554648845857?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9x70tL5v6OyhRVcVqf1brOzMBFupHaPOhzkFQJoAGAkLZzBHiByx787wf7AvJhd9ABgU=&authtoken=LhTSAqmtU9G3jZZaXcGsKwI=')
        bot.sendMessage(chat_id=update.message.chat_id,
                        text = "당신의 성격 카드는 '심판' 입니다! 이 카드는 옳고 그름에 대한 판단이 바르고,정의로운 사람을 말합니다. 희생을 감수해 진리를 드러내고자 하며 억울한 사람을 보면 무심해지기 어려워 적극 개입합니다.")
    elif dd == 21 :
        bot.send_photo(chat_id=update.message.chat_id,
                       photo='http://thumb1.photo.cloud.naver.com/3472427554648860961?type=m3&setidc=2&filelink=vbDHg5Gj4B1dZofT7fR9x6vWAqAFs8f5zGm0SDoi2q9PezVrDoVJU4tHCrJOgDunNcKfwdHq9CUmjXAacUWU1QU=&authtoken=b6yORNyaur70X8XEMu7JoQI=')
        bot.sendMessage(chat_id=update.message.chat_id,
...
def get_message( bot, update):
    ...
    if '심리테스트' in text and '심리' in text:
        ...
        bot.send_message(chat_id=chat_id, text= '/realtaro 를 입력해주세요.')
    elif '사자' in text:
    ...
    #생일점
    elif (int(update.message.text)>10000000) :
    ...
    #오늘의 운세
    elif (int(update.message.text)>= 0 and int(update.message.text)<9) :
        ...
        bot.sendMEssage(chat_id= chat_id , text = "다시 입력해주실래요?")
# 전역
result = [0,0,0]
