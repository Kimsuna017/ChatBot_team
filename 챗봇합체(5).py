...
TEST, REALTARO, MENU, TARO_B, TARO_D, DOOR, GREEN, BLUE, RED, PURPLE, GREY = range(11)
...
def test_menu(bot, update):
    ...
    show_list.append(InlineKeyboardButton("2.동물", callback_data=str(DOOR)))

    show_list.append(InlineKeyboardButton("3.사진", callback_data=str(DOOR)))

    show_list.append(InlineKeyboardButton("4.숫자", callback_data=str(DOOR)))

    show_list.append(InlineKeyboardButton("5.취소", callback_data=str(DOOR)))
