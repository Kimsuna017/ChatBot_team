...
def crawl_animal(bot, update):
    ...
    bot.sendMessage(chat_id=update.message.chat_id, text='이 중 가장 먼저 떠오르는 동물은 무엇인가요?')
...
def get_message(bot, update):
    ...
    if '심리테스트' in text and '심리' in text:
        ...
        if text.isdigit() == False:
            bot.send_message(chat_id=update.message.chat_id, text='잘못입력하였습니다.\n다시 입력하세요!')
